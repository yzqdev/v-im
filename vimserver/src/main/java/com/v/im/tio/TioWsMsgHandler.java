...
import com.v.im.entity.Message;
import com.v.im.entity.SendInfo;
import com.v.im.common.utils.ChatUtils;
import com.v.im.entity.ImMessage;
import com.v.im.service.IImMessageService;
        ...
        try {
            ...
            //真正的消息
                ...
                if (ChatUtils.FRIEND.equals(message.getType())) {
                    SetWithLock<ChannelContext> channelContextSetWithLock = Tio.getChannelContextsByUserid(channelContext.tioConfig, message.getId());
                    //用户没有登录，存储到离线文件
